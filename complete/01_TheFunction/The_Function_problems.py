...
print('1.', tuple_sum([(1,2), (10,20)],[(3,4), (30,40)]))
...
print('2.', inv_dict({'goodbye':  'au revoir', 'thank you': 'merci'}))
...
print('3b.', comprehension_with_row)

comprehension_without_row = [ [i+j for j in range(20)] for i in range(15) ]

print('4b.', comprehension_without_row)
