...
print('1.', minutes_in_week)

## 2: (Task 0.5.2) Remainder
#For this task, your expression must use //
a = 2304811
b = 47
remainder_without_mod = a - (a // b)*b
print('2.', remainder_without_mod)

## 3: (Task 0.5.3) Divisibility
a = 673
b = 909
c = 3
divisible_by_3 = (a + b) % c == 0
print('3.', divisible_by_3)
...
X1 = {4, 5, 6}
Y1 = {7, 11, 19}
nine_element_set = { x*y for x in X1 for y in Y1 }
print('7.', nine_element_set)
...
X2 = {1, 10, 100}
Y2 = {5, 50, 500}
five_element_set = { x*y for x in X2 for y in Y2 }
print('8.', five_element_set)
...
print('21.', value_list_modified_1, value_list_modified_2)
...
print('22.', square_dict)

## 23: (Task 0.5.24) Making the identity function
D = {'red','white','blue'}
# Replace {...} with a one-line dictionary comprehension
identity_dict = {a:a for a in D}
print('23.', identity_dict)
