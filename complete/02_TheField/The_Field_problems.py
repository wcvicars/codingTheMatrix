...
print('1.', myFilter([10,15,20,25],10))
...
f = {0:'a',1:'b'}
g = {'a':'apple','b':'banana'}
print('3.', myFunctionComposition(f,g))
...
def transform(a, b, L):
    ...
    '''
    result = []
    def f(a, b, z): return a*z + b
    for num in L:
        result.append(f(a, b, num))
    return result

print('10.', transform(3,2,[1,2,3]))
